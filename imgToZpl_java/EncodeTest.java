...
public class EncodeTest {
	...
	private static String logoPath = "d:\\lg.jpg";

	public static void Encode_QR_CODE() throws IOException, WriterException {
		MatrixToImageWriter mw = new MatrixToImageWriter();
		...
		System.out.println(mw.convertToZpl(bitMatrix, ""));

		// 生成二维码

		File outputFile = new File("d:" + File.separator + "new-1.png");// 指定输出路径

		mw.writeToFile(bitMatrix, format,logoPath, outputFile);
...
//			Encode_QR_CODE();
			System.out.println(QrCodeUtil.getInstance().qrCodePicToZPL("hshhwhwwwjwjwj", 300, 300, logoPath));
